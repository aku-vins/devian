...
exports.run = async(client, message, args, color, prefix) => {
	...
	.setDescription('\`\`\`A statistics monitoring module. Contains essential information regarding our service and bot information. Wrapped with beautiful Discord.js Interactive Library and MessageEmbed amazing Constructor. Made with ❤️ by Vins_Developer Support Team.\`\`\`')
	.addField('Owners', '\`\`\`• Vins 2106#7613\`\`\`')
