...
module.exports = async (client, message) => {
  ...
  let values = blacklist[message.author.id].checker
    if (values === 1) {
      message.author.send(`Sorry, you\'ve been **BLACKLISTED** from using ${client.user.username} because violating **Our Rules**. Contact Vins 2106#7613 ( bot owner ) if you want to appeal.`);
    } else {
